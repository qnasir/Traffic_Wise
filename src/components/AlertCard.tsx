...
const fakeReports: Report[] = [
  {
    ...
    reportedBy: "JohnDoe123",
    reportedAt: new Date("2024-03-10T08:30:00Z"),
    upvotes: 12,
    downvotes: 2,
    resolved: false,
    status: "pending", // Adjust based on your ReportStatus enum
    adminNotes: "Waiting for further verification.",
    verifiedBy: undefined,
    lastUpdated: new Date("2024-03-10T10:00:00Z"),
  },
  {
    id: "2",
    title: "Power Outage",
    ...
    imageUrl: "https://via.placeholder.com/150",
    reportedBy: "JaneSmith456",
    reportedAt: new Date("2024-03-09T22:15:00Z"),
    upvotes: 30,
    downvotes: 5,
    resolved: false,
    status: "in_progress",
    adminNotes: "City officials have been notified.",
    verifiedBy: "Admin1",
    lastUpdated: new Date("2024-03-10T06:45:00Z"),
  },
  {
    id: "3",
    ...
    imageUrl: "https://via.placeholder.com/150",
    reportedBy: "RoadWatcher99",
    reportedAt: new Date("2024-03-08T14:00:00Z"),
    upvotes: 8,
    downvotes: 1,
    resolved: true,
    status: "resolved",
    adminNotes: "Maintenance team has fixed the issue.",
    verifiedBy: "Admin2",
    lastUpdated: new Date("2024-03-09T10:30:00Z"),
  },
];
