...
const Index = () => {
  ...
  const handlePageChange = (page: number) => {
    setCurrentPage(page);
    window.scrollTo({ top: document.getElementById("reports").offsetTop, behavior: "smooth" });
  };
  ...
  const handleTabChange = (value: string) => {
    ...
    setActiveTab(value);
    toast.info(
      `Showing ${value === "all" ? "all reports" : `${value} reports`}`
    );
  };
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section
        className={`relative transition-all duration-300 ${
          showHeroSection ? "h-[100vh] opacity-100" : "h-[100vh] opacity-95"
        }`}
      >
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center text-white">
          <div className="max-w-3xl animate-fade-up">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8">
              Join thousands of drivers helping each other navigate safely with
              real-time road alerts, traffic updates, and hazard warnings.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 animate-fade-up">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Stay informed about road conditions with real-time updates from
            ...
            <div className="flex items-center gap-2 flex-wrap justify-center md:justify-start">
              ...
              <Badge
                ...
                className={`cursor-pointer ${
                  !filterSeverity ? "bg-primary/10 text-primary" : ""
                }`}
              ...
              <Badge
                ...
                className={`cursor-pointer ${
                  filterSeverity === "low"
                    ? "bg-alert-low/20 text-alert-low border-alert-low/30"
                    : ""
                }`}
              ...
              <Badge
                ...
                className={`cursor-pointer ${
                  filterSeverity === "medium"
                    ? "bg-alert-medium/20 text-alert-medium border-alert-medium/30"
                    : ""
                }`}
              ...
              <Badge
                ...
                className={`cursor-pointer ${
                  filterSeverity === "high"
                    ? "bg-alert-high/20 text-alert-high border-alert-high/30"
                    : ""
                }`}
      ...
      <section id="report-section" className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Help keep our roads safe by reporting hazards, traffic jams,
