...
import { useAlerts, Report, ReportStatus, ReportType, AlertSeverity } from '@/context/AlertsContext';
...
import { 
  Shield, Edit, CheckCircle, Clock, Loader, AlertCircle, 
  BarChart2, PieChart as PieChartIcon, Search, Filter, ListFilter, TrafficCone 
} from 'lucide-react';
                        ...
                        {sortedReports.length > 0 ? (
                          sortedReports.map((report) => (
                            <tr key={report.id} className="border-b hover:bg-gray-50 dark:hover:bg-gray-800/50">
                              ...
                              <td className="py-3 px-4">
                                <Badge className={`${statusColorMap[report.status]} flex items-center gap-1`}>
                        ...
                        <BarChart data={severityChartData}>
                          ...
                          <Bar dataKey="value">
                            {severityChartData.map((entry, index) => (
                              <Cell 
                                key={`cell-${index}`} 
                                fill={getSeverityColor(entry.name.toLowerCase() as AlertSeverity)} 
                              />
                            ))}
                          </Bar>
                        </BarChart>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg text-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">Total Reports</p>
                      </div>
                      <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg text-center">
                      ...
                      <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg text-center">
                        <p className="text-2xl font-bold text-red-500">{stats.byStatus.pending || 0}</p>
